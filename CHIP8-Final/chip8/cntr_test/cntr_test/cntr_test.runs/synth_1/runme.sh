...
HD_PWD='H:/EECS_443_project/C8VHDL/Chip8/chip8/cntr_test/cntr_test/cntr_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cntr_test.vds -m64 -mode batch -messageDb vivado.pb -notrace -source cntr_test.tcl
