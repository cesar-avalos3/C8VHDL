...
HD_PWD='H:/EECS_443_project/C8VHDL/Chip8/chip8/cntr_test/cntr_test/cntr_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cntr_test.vdi -applog -m64 -messageDb vivado.pb -mode batch -source cntr_test.tcl -notrace
