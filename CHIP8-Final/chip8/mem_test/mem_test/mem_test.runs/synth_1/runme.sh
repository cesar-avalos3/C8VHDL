...
HD_PWD='H:/EECS_443_project/C8VHDL/Chip8_cur_BAK/chip8/mem_test/mem_test/mem_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_test.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mem_test.tcl
