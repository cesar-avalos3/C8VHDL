...
HD_PWD='H:/EECS_443_project/C8VHDL/Chip8_test/chip8/chip8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chip_8B_board_debug.vdi -applog -m64 -messageDb vivado.pb -mode batch -source chip_8B_board_debug.tcl -notrace
