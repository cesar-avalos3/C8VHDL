...
HD_PWD='H:/EECS_443_project/C8VHDL/Chip8_cur_BAK/chip8/chip8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chip_8A_board.vds -m64 -mode batch -messageDb vivado.pb -notrace -source chip_8A_board.tcl
