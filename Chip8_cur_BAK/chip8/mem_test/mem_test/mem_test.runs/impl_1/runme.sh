...
HD_PWD='H:/EECS_443_project/C8VHDL/Chip8_cur_BAK/chip8/mem_test/mem_test/mem_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mem_test.vdi -applog -m64 -messageDb vivado.pb -mode batch -source mem_test.tcl -notrace
